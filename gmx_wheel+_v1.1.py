...
def gen_wheel(results_input, projection_start, projection_end):
  ...
  widths = np.deg2rad(data["Angle spread"])
...
def combine_results(results_input,results_input2,results_input3):
  ...
  results3 = get_data(results_input3, projection_start, projection_end)
...
def main(mode, trajectory_name, tpr_name, time_start, end_time, helix_start, helix_end, results_input, results_input2, results_input3, projection_start, projection_end):
  ...
  if mode == "process":
    ...
    gen_wheel('results_combined.txt', projection_start, projection_end)
...
if __name__ == '__main__':
  main(mode, trajectory_name, tpr_name, time_start, end_time, helix_start, helix_end, results_input, results_input2, results_input3, projection_start, projection_end)   
